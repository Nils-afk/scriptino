                    ...
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                ...
                                <p className="font-semibold text-xl text-white">Scriptino Bot</p>
                            </div>
...
<a href="https://top.gg/bot/984751927076192307">
  <img src={"https://top.gg/api/widget/servers/984751927076192307.svg"}/>
</a>
<div className="py-1"></div>
<a href="https://top.gg/bot/984751927076192307">
  <img src={"https://top.gg/api/widget/upvotes/984751927076192307.svg"}/>
</a>
<div className="py-1"></div>
<a href="https://top.gg/bot/984751927076192307">
  <img src={"https://top.gg/api/widget/owner/984751927076192307.svg"}/>
</a>
                                </div>
                            </Menu>
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://top.gg/bot/984751927076192307/vote">
                            ...
                            <div>
                                <a href="https://top.gg/bot/984751927076192307" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Invite Bot
                                </a>
                            </div>
                        </div>
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://discord.gg/TNTvdjVCbb">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                            ...
                            <div>
                                <Link href="https://github.com/nils-afk">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                            ...
                            <div>
                                <Link href="https://youtube.com/UCZ-UrvcsTYxG2Xi3jh09Mew">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
                    ...
                    <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <p className="text-white text-center sm:text-left text-opacity-50">
                            {new Date().getFullYear()} &copy; Scriptino Bot
                        </p>
