...
<div className="py-3"></div>
<p>⊳ To use certain discord bot commands, you need to vote for the <a className="text-white" href="https://top.gg/bot/984751927076192307/vote">Astra</a> bot at certain intervals.</p>
</div>
    </div>
  );
}
